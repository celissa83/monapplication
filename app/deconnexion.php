...
<head>
    <title>Mon App - Déconnexion</title>
    <!-- ENCODING -->
    <meta charset="UTF-8" />
    <!-- AUTHOR -->
        ...
        <div class="d-sm-flex justify-content-sm-center d-block">
            <div class="card card-light p-0 my-sm-4 my-0">
                <div class="box-account">
                    ...
                    <h6 class="box-account-title">Connexion </h6>
                    <p>Vous avez été déconneté</p>
                    ...
                    <button class="btn btn-primary btn-lg btn-block" id="connexion">Se connecter</button>
                    <p class="box-account-text mt-3">S'inscrire ?<a href="inscription.php?" class="text-info">Inscription</a></p>
                    <p class="box-account-text mt-3">Mot de passe oublié ? <a href="passwordOublie.php?" class="text-info">Récupérer</a></p>
                </div>
            </div>
        </div>
    </div>
