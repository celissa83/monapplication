...
(function () {
    ...
    $.fn.prototipoCalendar = function(para) {
        ...
        var weekNames = [ 'Lun', 'Mar', 'Mer', 'Jeu', 'Ven', 'Sam' ,'Dim'];
        ...
        var construct = function(){
            ...
            for (var i = 0; i < notes_month.length; i++) {
                var li = $("<li><span class='title'>Evénement "+(i+1)+"</span><span class='info'>"+notes_month[i].content+"</span><span class='date'>"+ notes_month[i].date +"-"+monthNames[currentMonth]+" / "+notes_month[i].time+"</span></li>");
                list.append(li);
            }
